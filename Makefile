...
# Template: app
# Command: /opt/Qt/6.1.2/gcc_64/bin/qmake -o Makefile pcap-test.pro
#############################################################################
...
INCPATH       = -I. -I/opt/Qt/6.1.2/gcc_64/mkspecs/linux-g++
...
DISTDIR = /root/gilgil/pcap-test/.tmp/pcap-test1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -lpcap   
AR            = ar cqs
...
Makefile: pcap-test.pro /opt/Qt/6.1.2/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt/6.1.2/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/common/sanitize.conf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/common/gcc-base.conf \
